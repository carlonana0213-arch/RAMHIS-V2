          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            <div className="contact-field">
              ...
              <select required>
                ...
                <option value="volunteer">Would you like to volunteer</option>
      ...
      {showConfirm && (
        <div className="contact-modal-overlay">
          <div className="contact-modal">
            ...
            <p>
              By sending this message, you agree that RAM Philippines may review
              your submitted information and contact you regarding your inquiry.
            </p>
      ...
      {showSuccess && (
        <div className="contact-modal-overlay">
          <div className="contact-modal">
            ...
            <p>
              Your message has been received. Our staff will contact you
              shortly.
            </p>
